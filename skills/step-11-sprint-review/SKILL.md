...
*   **Mode A (Prework & Deliverables Generation - Pre-Meeting):** 
    *   *Keywords:* "prepare for review", "create slides", "chuẩn bị sprint review", "tạo slide", "sprint report", "báo cáo sprint".
    *   *Action:* Silently load `checklists/sprint-review-prework-checklist.md`. Conduct the mandatory AI-to-User interview with the **Product Owner**. Only after all answers are validated, prompt the user to choose a deliverable:
        *   **[A] Sprint Review Slide Deck** (`templates/sprint-review-slide-deck.md`)
        *   **[B] Agile A4 Sprint Report** (`templates/agile-a4-sprint-report.md`)
...
*   **[A] Sprint Review Slide Deck:** Ceremony presentation slides and speaker notes cache.
*   **[B] Agile A4 Sprint Report:** Formal A4 summary report for steering committee and business stakeholders.
...
Before ending the turn, the Agent MUST verify:
*   [ ] Have I run the prework checklist before generating any slide or report?
*   [ ] Does the A4 report contain the committed vs. delivered story point comparison?
